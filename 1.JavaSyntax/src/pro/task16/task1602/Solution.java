...
public class Solution {
    ...
    static void fixDate(List<Date> brokenDates) {
        ...
        for (Date dateFormList : brokenDates){
            if (dateFormList.after(current)){
                dateFormList.setYear(dateFormList.getYear() - 1900);
                dateFormList.setMonth(dateFormList.getMonth() - 1);
            }
        }
    }
}
