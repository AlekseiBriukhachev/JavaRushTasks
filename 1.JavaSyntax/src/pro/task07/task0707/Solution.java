...
public class Solution {
    ...
    public static void main(String[] args) {
        System.out.print(char2);//1
        System.out.print(char1);//2
        System.out.print(char5);//3
        System.out.print(char9);//4
        System.out.print(char4);//5
        System.out.print(char8);//6
        System.out.print(char7);//7
        System.out.print(char6);//8
        System.out.print(char10);//9
        System.out.print(char3);//10
        System.out.println();
    }
}
